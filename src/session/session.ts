...
import { permissionOptionsForPlan } from "../acp/plan-gate";
...
import { mergeHostSlashCommands } from "../composer/slash-filter";
...
export function sessionUiSnapshot(
  ...
  messages.push({
    type: "commandsUpdate",
    commands: mergeHostSlashCommands(session.client?.availableCommands ?? []),
  });
