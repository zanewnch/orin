...
(function (root) {
  ...
  const ROWS = [
    ...
    },
    {
      ...
      // Any remote whose host can sign in to GitHub at all — cloud or desk.
      // Briefly cloud-only; see `githubLoginWithToken` in remote-policy.ts for
      // why that came back out.
